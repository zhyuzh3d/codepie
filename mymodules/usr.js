...
if (!tmpNameArr) throw Error('usr.js get tmpusrarr failed!');


usr.newUsrCo = newUsrCo;
/*创建一个usr键hash
...
newUsrCo().then(function (res) {
    console.log('>>rds new usr', res);
}, __errhdlr)
