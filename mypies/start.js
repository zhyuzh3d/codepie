...
/*实际函数运行*/
require(['jquery', 'bootstrap', 'swal', 'toastr', 'piejs'],
    function ($, bootstrap, swal, toastr, piejs) {
        ...
        function pieMain() {
            ...
            var grpStart = function () {
                ...
                $('<div style="color:#888">您可以使用 <span class="glyphicon glyphicon-plus"></span> 创建，使用 <span class="glyphicon glyphicon-remove"></span> 删除，<span class="glyphicon glyphicon-fire"></span> 运行或 <span class="glyphicon glyphicon-pencil"></span> 编辑</div>').appendTo(tipGrp);
